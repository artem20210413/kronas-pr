                ...
                <div class="row">
                    @if($id != 0)
                        <div class="col-2">
                            ...
                            <lable>ID</lable>
                            <input disabled placeholder="id" class="form-control mt-1" type="number" name="id"
                                   value="{{$id}}">
                        ...
                        <div class="col-10"><!--col-10-->
                            @else
                                <div class="col-12"><!--col-10-->
                                    @endif
                                    <lable>Decor</lable>
                                    <input autofocus placeholder="Decor name" class="form-control  mt-1" type="text"
                                           name="decor_name"
                                           value="{{$decorName}}">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <button class="w-100 btn btn-dark btn mt-3" onclick="history.back()">Go Back
                                        </button>
                                    </div>
                                    <div class="col-6">
